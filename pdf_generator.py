...
def generate_declaration_pdf(data: dict, submission_id: str, submitted_at: str, output_path: str):
    ...
    declaration_text = (
        ...
        "mobile number, and I authorize ICICI Lombard to use these details for the "
    ...
    story.append(_kv_table([
        ("Mobile Number Verified", data["otp_verified_mobile"]),
        ("Verification Method", "SMS OTP"),
    ...
    story.append(Paragraph(
        "This is a system-generated declaration form. Customer consent was captured via mobile "
